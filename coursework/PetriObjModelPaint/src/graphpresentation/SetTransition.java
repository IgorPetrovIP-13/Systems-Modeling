...
public class SetTransition extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        destributionComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "null", "exp", "unif", "norm", "poisson" }));
    ...
    private void setTimeDelay() { // modified by Katya 08.12.2016
        ...
        if (distributionParamName != null && !distributionParamName.isEmpty()) {
            ...
            if (destributionComboBox.getSelectedIndex()==4) {
                petriTran.setDistribution("poisson", parametrValue);
                paramDeviationTextField.setEditable(false);
            }
    ...
    private void getTimeDelay() { // modified by Katya 08.12.2016
        ...
        if ("poisson".equals(distribution)) {
            destributionComboBox.setSelectedIndex(4);
            paramDeviationTextField.setEditable(false);
        }
